...
/**
 * Astro-specific framework info section
 */
export function AstroFrameworkInfo() {
	return (
		<div className="mt-4 rounded-lg bg-purple-900/30 p-4">
			<h3 className="mb-2 font-semibold text-purple-300">Astro Integration</h3>
			<p className="text-slate-400 text-sm">
				This example uses Astro's{" "}
				<code className="rounded bg-slate-700 px-1 text-slate-200">
					client:only="react"
				</code>{" "}
				directive to render the desktop UI entirely on the client. Routes are
				pre-generated using{" "}
				<code className="rounded bg-slate-700 px-1 text-slate-200">
					getStaticPaths()
				</code>
