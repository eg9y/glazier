...
/**
 * Astro-specific framework badge
 */
export function AstroFrameworkBadge() {
	return (
		<span className="rounded-full bg-purple-600 px-3 py-1 font-medium text-sm text-white">
			Astro
		</span>
	);
}
...
/**
 * Astro-specific framework description
 */
export function AstroFrameworkDescription() {
	return (
		<>
			...
			. React components are hydrated client-side using{" "}
			<code className="rounded bg-slate-700 px-1 text-slate-200">
				client:only="react"
			</code>
			.
